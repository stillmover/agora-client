...
export type PutCommentsByIdVoteBodyOneVoteType = typeof PutCommentsByIdVoteBodyOneVoteType[keyof typeof PutCommentsByIdVoteBodyOneVoteType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PutCommentsByIdVoteBodyOneVoteType = {
  upvote: 'upvote',
  downvote: 'downvote',
} as const;
