 ...
 */
import type { PutCommentsByIdVoteBodyOneVoteType } from './putCommentsByIdVoteBodyOneVoteType';

export type PutCommentsByIdVoteBodyOne = {
  voteType: PutCommentsByIdVoteBodyOneVoteType;
};
