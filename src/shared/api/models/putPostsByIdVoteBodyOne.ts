 ...
 */
import type { PutPostsByIdVoteBodyOneVoteType } from './putPostsByIdVoteBodyOneVoteType';

export type PutPostsByIdVoteBodyOne = {
  voteType: PutPostsByIdVoteBodyOneVoteType;
};
